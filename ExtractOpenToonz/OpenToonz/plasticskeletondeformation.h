...
typedef struct PlasticSkeletonVertexDeformation final : public TPersist {
...
said skeletons.
*/
class PlasticSkeletonDeformation final : public TSmartObject,
                                               public TPersist {
  DECLARE_CLASS_CODE
...
#ifdef _WIN32
template class TSmartPointerT<PlasticSkeletonDeformation>;
#endif
