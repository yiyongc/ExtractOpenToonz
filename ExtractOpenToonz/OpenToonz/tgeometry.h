...
#ifdef _WIN32
template class TPointT<int>;
template class TPointT<double>;
#endif
...
#ifdef _WIN32
template class T3DPointT<int>;
template class T3DPointT<double>;
#endif
...
*/
class TThickPoint : public TPointD
{
public:
	double thick;
...
#ifdef _WIN32
template class TDimensionT<int>;
template class TDimensionT<double>;
#endif
...
#ifdef _WIN32
template class TRectT<int>;
template class TRectT<double>;
#endif
...
extern const TPointD napd;
extern const TPoint nap;
extern const T3DPointD nap3d;
extern const TThickPoint natp;
extern const TRectD infiniteRectD;
extern const TRectI infiniteRectI;
}
...
class TTranslation : public TAffine
{
public:
	TTranslation(){};
...
class TRotation : public TAffine
{
public:
	TRotation(){};
