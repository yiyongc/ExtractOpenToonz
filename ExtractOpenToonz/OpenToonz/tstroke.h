 ...
 */
class TStroke final : public TSmartObject {
  DECLARE_CLASS_CODE
...
//! deleted)
TStroke *joinStrokes(const TStroke *stroke1, const TStroke *stroke2);
...
void computeQuadraticsFromCubic(
