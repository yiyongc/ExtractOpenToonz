...
class TTextureMesh : public tcg::TriMesh<TTextureVertex, tcg::Edge, tcg::FaceN<3>>, public TSmartObject//, public TPersist
{
...
#ifdef _WIN32
template class TSmartPointerT<TTextureMesh>;
#endif
...
class TMeshImage : public TImage
{
	class Imp;
...
#ifdef _WIN32
template class TSmartPointerT<TMeshImage>;
template class TDerivedSmartPointerT<TMeshImage, TImage>;
#endif

class TMeshImageP : public TDerivedSmartPointerT<TMeshImage, TImage>
{
public:
	TMeshImageP() {}
	TMeshImageP(TMeshImage *image) : DerivedSmartPointer(image) {}
	TMeshImageP(TImageP image) : DerivedSmartPointer(image) {}
	TMeshImage* getPointer() {
		return m_pointer;
	}
#if !defined(_WIN32)
