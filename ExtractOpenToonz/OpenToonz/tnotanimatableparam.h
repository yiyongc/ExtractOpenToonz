...
template <class T>
class TNotAnimatableParam : public TParam {
...
#ifdef _WIN32
template class TNotAnimatableParam<int>;
class TIntParam;
template class TPersistDeclarationT<TIntParam>;
#endif

class TIntParam final : public TNotAnimatableParam<int> {
...
#ifdef _WIN32
template class TNotAnimatableParam<bool>;
class TBoolParam;
template class TPersistDeclarationT<TBoolParam>;
#endif

class TBoolParam final : public TNotAnimatableParam<bool> {
...
#ifdef _WIN32
template class TNotAnimatableParam<TFilePath>;
class TFilePathParam;
template class TPersistDeclarationT<TFilePathParam>;
#endif

class TFilePathParam final : public TNotAnimatableParam<TFilePath> {
...
#ifdef _WIN32
template class TNotAnimatableParam<std::wstring>;
class TStringParam;
template class TPersistDeclarationT<TStringParam>;
#endif

class TStringParam final : public TNotAnimatableParam<std::wstring> {
...
class TEnumParam final : public TNotAnimatableParam<int> {
...
#ifdef _WIN32
template class TNotAnimatableParam<double>;
class TNADoubleParam;
template class TPersistDeclarationT<TNADoubleParam>;
#endif

class TNADoubleParam final : public TNotAnimatableParam<double> {
