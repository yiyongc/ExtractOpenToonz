...
class TRaster : public TSmartObject
{
...
public:
	...
	//Shifted here because tbigmemorymanager giving problems
...
#ifdef _WIN32
template class TSmartPointerT<TRaster>;
#endif
...
template class  TSmartPointerT<TRasterT<TPixel32>>;
template class  TRasterPT<TPixel32>;

template class  TSmartPointerT<TRasterT<TPixel64>>;
template class  TRasterPT<TPixel64>;

template class  TSmartPointerT<TRasterT<TPixelGR8>>;
template class  TRasterPT<TPixelGR8>;

template class  TSmartPointerT<TRasterT<TPixelGR16>>;
template class  TRasterPT<TPixelGR16>;

template class  TSmartPointerT<TRasterT<TPixelGRD>>;
template class  TRasterPT<TPixelGRD>;

template class  TSmartPointerT<TRasterT<TPixelCY>>;
template class  TRasterPT<TPixelCY>;
