...
void MsgBoxInPopup(MsgType type, const QString &text);
...
Dialog *createMsgBox(MsgType type, const QString &text,
...
*/
class RadioButtonDialog final : public DVGui::Dialog {
  Q_OBJECT
...
int RadioButtonMsgBox(MsgType type, const QString &labelText,
                            const QList<QString> &buttons, QWidget *parent = 0);

//-----------------------------------------------------------------------------

class ProgressDialog : public DVGui::Dialog {
  Q_OBJECT
