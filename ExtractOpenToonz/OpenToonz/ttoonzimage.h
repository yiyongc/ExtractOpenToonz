...
class TToonzImage final : public TImage {
...
#ifdef _WIN32
template class TSmartPointerT<TToonzImage>;
template class TDerivedSmartPointerT<TToonzImage, TImage>;
#endif

class TToonzImageP final
