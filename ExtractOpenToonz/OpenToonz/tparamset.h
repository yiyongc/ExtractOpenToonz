...
#ifdef _WIN32
template class TSmartPointerT<TParamSet>;
template class TDerivedSmartPointerT<TParamSet, TParam>;
#endif
...
#ifdef _WIN32
class TPointParam;
template class TPersistDeclarationT<TPointParam>;
#endif
...
class TPointParam final : public TParamSet {
...
#ifdef _WIN32
class TPixelParam;
template class TPersistDeclarationT<TPixelParam>;
#endif
...
class TPixelParam final : public TParamSet {
...
#ifdef _WIN32
class TRangeParam;
template class TPersistDeclarationT<TRangeParam>;
#endif
...
class TRangeParam final : public TParamSet {
