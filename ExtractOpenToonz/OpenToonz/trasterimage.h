...
class TRasterImage : public TImage
{
...
#ifdef _WIN32
template class TSmartPointerT<TRasterImage>;
template class TDerivedSmartPointerT<TRasterImage, TImage>;
#endif

class TRasterImageP : public TDerivedSmartPointerT<TRasterImage, TImage>
{
public:
	TRasterImageP() {}
