...
*/
class TParam : public TSmartObject, public TPersist {
  DECLARE_CLASS_CODE
  std::string m_name;
...
#ifdef _WIN32
template class TSmartPointerT<TParam>;
#endif
...
#define DVAPI_PARAM_SMARTPOINTER(PARAM)                                        \
  template class TSmartPointerT<PARAM>;                                  \
  template class TDerivedSmartPointerT<PARAM, TParam>;
#else
#define DVAPI_PARAM_SMARTPOINTER(PARAM)
#endif
...
#define DEFINE_PARAM_SMARTPOINTER(PARAM, TYPE)                                 \
  DVAPI_PARAM_SMARTPOINTER(PARAM)                                              \
                                                                               \
  class PARAM##P final : public TDerivedSmartPointerT<PARAM, TParam> {   \
  public:                                                                      \
