...
/*! \brief ParamField.
                ...
                Inherits \b QWidget.
*/
class ParamField : public QWidget {
  Q_OBJECT
...
class ParamFieldKeyToggle final : public QWidget {
  Q_OBJECT
...
template <class T, class ParamP>
class AnimatedParamField : public ParamField {
protected:
...
class MeasuredDoubleParamField final
...
class MeasuredRangeParamField final
...
class RgbLinkButton final : public QPushButton {
  Q_OBJECT
...
class SpectrumParamField final
...
class BoolParamField final : public ParamField {
  Q_OBJECT
...
class IntParamField final : public ParamField {
  Q_OBJECT
...
class StringParamField final : public ParamField {
  Q_OBJECT
...
class ToneCurveParamField final
...
namespace component {
class LineEdit_double final : public ParamField {
...
namespace component {
class LineEdit_int final : public ParamField {
  Q_OBJECT;
...
namespace component {
class CheckBox_bool final : public ParamField {
  Q_OBJECT;
...
namespace component {
class RadioButton_enum final : public ParamField {
  Q_OBJECT;
...
namespace component {
class LineEdit_string final : public ParamField {
  Q_OBJECT;
