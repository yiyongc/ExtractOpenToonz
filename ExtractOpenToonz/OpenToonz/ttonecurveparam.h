...
class TToneCurveParam final : public TParam {
...
#ifdef _WIN32
template class TSmartPointerT<TToneCurveParam>;
template class TDerivedSmartPointerT<TToneCurveParam, TParam>;
#endif

class TToneCurveParamP final
