...
template class TPersistDeclarationT<TSpectrumParam>;
#endif

//---------------------------------------------------------

class TSpectrumParam final : public TParam {
...
#ifdef _WIN32
template class TSmartPointerT<TSpectrumParam>;
template class TDerivedSmartPointerT<TSpectrumParam, TParam>;
#endif

class TSpectrumParamP final
