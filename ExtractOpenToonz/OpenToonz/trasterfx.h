...
#ifdef _WIN32
template class TSmartPointerT<TRasterFx>;
template class TDerivedSmartPointerT<TRasterFx, TFx>;
#endif

//-------------------------------------------------------------------

class TRasterFxP final : public TDerivedSmartPointerT<TRasterFx, TFx> {
public:
  TRasterFxP() {}
...
#ifdef _WIN32
template class TFxPortT<TRasterFx>;
#endif
...
class TGeometryFx : public TRasterFx {
public:
  TGeometryFx();
...
#ifdef _WIN32
template class TSmartPointerT<TGeometryFx>;
template class TDerivedSmartPointerT<TGeometryFx, TFx>;
#endif

//-------------------------------------------------------------------

class TGeometryFxP final
...
#ifdef _WIN32
template class TFxPortT<TGeometryFx>;
#endif

class TGeometryPort final : public TFxPortT<TGeometryFx> {
public:
...
class NaAffineFx final : public TGeometryFx {
