...
class HistogramGraph final : public QWidget {
  Q_OBJECT
...
class ChannelBar final : public QWidget {
  Q_OBJECT
...
class HistogramView final : public QWidget {
  Q_OBJECT
...
class Histograms final : public QStackedWidget {
  Q_OBJECT
...
class Histogram final : public QWidget {
  Q_OBJECT
