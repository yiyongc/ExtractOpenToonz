...
class TEnumProperty;
class TDoublePairProperty;
class TIntPairProperty;
class TStyleIndexProperty;
class TPointerProperty;
...
//---------------------------------------------------------
#ifdef _WIN32
template class TRangeProperty<int>;
template class TRangeProperty<double>;
#endif
//---------------------------------------------------------
...
class TBoolProperty final : public TProperty {
public:
...
class TStringProperty final : public TProperty {
public:
...
class TStyleIndexProperty final : public TProperty {
public:
...
class TPointerProperty final : public TProperty {
public:
...
class TEnumProperty final : public TProperty {
public:
