...
#include "swatchviewer.h"
#include "fxhistogramrender.h"
...
/*! \brief ParamsPage. View a page with fx params.
                ...
                Inherits \b QWidget.
*/
class ParamsPage final : public QFrame {
  Q_OBJECT
...
/*! \brief ParamsPageSet. Contains a stack of page \b ParamsPage with relative
   tab.
                ...
                Inherits \b QWidget.
*/
class ParamsPageSet final : public QWidget {
  Q_OBJECT
...
/*! \brief ParamViewer. Contains a stack of \b ParamsPageSet.
                ...
                Inherits \b QWidget.
*/
class ParamViewer final : public QFrame {
  Q_OBJECT
...
class QActionGroup;
class FxSettings final : public QSplitter {
  Q_OBJECT
